...
- **배경**:
  - 🚙 시장 변화와 관심 증가
      ...
      * 이러한 변화 속에서 외산차 시장의 흐름과 주요 브랜드의 동향을 파악하고, 데이터를 통해 인사이트를 제공하기 위해 본 프로젝트를를 기획.
...
| RQ\_005 | 기능   | 2025년 점유율 예측 기능       | 데이터 트렌드 기반으로 2025년 외산차 점유율 및 모델을 예측하여 제공.     | 2025 TOP 5 외산차 기업 FAQ 조회   |
...
3. 📝 **2025 외산차 Top 5 기업 예측**
    - 선형 회귀를 통해 예측한 2025 외산차 기업 점유율과 Top 5기업 확인 가능
